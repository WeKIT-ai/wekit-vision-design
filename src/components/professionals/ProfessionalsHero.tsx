...
const ProfessionalsHero = () => {
  return (
    <section className="relative pt-20 pb-32 px-4 sm:px-6 lg:px-8 min-h-screen overflow-hidden">
      ...
      <div className="relative z-30 max-w-7xl mx-auto flex items-end justify-start min-h-[80vh] pb-16">
        <div className="text-left max-w-2xl space-y-8">
          ...
          <div className="bg-wekit-teal/80 backdrop-blur-sm p-6 max-w-2xl mb-8">
