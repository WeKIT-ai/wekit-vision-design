    ...
    <>
      ...
      <section className="py-24 md:py-32 px-6 md:px-12 bg-background">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold font-montserrat text-foreground mb-4 tracking-tight">
              Be Part of Reshaping the Future of Work
            </h2>
      ...
      <section className="py-24 md:py-32 px-6 md:px-12 bg-cinematic-subtle">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-white/50">
              Take the first step towards transforming youth development
            </p>
          </motion.div>
      ...
      <section className="py-24 md:py-32 px-6 md:px-12 bg-background">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              Connect with like-minded individuals passionate about youth development
            </p>
          </motion.div>
