    ...
    <section className="relative pt-32 pb-24 px-6 md:px-8 bg-wekit-soft overflow-hidden">
      <div className="max-w-6xl mx-auto">
        <div className="text-center space-y-8">
          <div className="inline-flex items-center gap-2 bg-background border border-border px-4 py-2 text-sm font-medium text-foreground">
          ...
          <div className="bg-card border border-border p-8 max-w-3xl mx-auto shadow-sm">
          ...
          <div className="pt-4 flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              size="lg" 
              className="bg-primary text-primary-foreground hover:bg-primary/90 px-10 py-6 text-lg font-medium shadow-sm hover:shadow-md transition-all duration-300 group"
            >
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground px-10 py-6 text-lg font-medium transition-all duration-300"
            >
              Download One-Pager
            </Button>
          </div>
